...
public class GUI extends JFrame {
    ...
    public GUI() {
        ...
        // ===== Haut : sélection dossier ou fichier =====
        JButton selectFolderButton = new JButton("Sélectionner un dossier");
        selectFolderButton.addActionListener(e -> ouvrirDossier());

        JButton selectFileButton = new JButton("Sélectionner un fichier MP3");
        selectFileButton.addActionListener(e -> ouvrirFichier());
    ...
    private String formatDuree(long secondes) {
    ...
    private void afficherMetadonnees(int row) {
        ...
        sb.append("Durée   : ").append(formatDuree(meta.getDuree())).append("\n");
